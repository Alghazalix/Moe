...
export const staticData = {
    ...
    nameDetails: {
        'يامن': {
            ...
            futuristic: 'اسم كلاسيكي ولكنه في الوقت نفسه عصري، يحافظ على جاذبيته وقيمته بمرور الوقت. لا يحمل أي دلالات سلبية قد تؤثر على مسيرة حامله المهنية أو الاجتماعية مستقبلاً.',
        ...
        'غوث': {
            ...
            uniqueness: 'فريد جداً وغير شائع، مما يمنح حامله تميزاً كبيراً ويجعله ملفتاً للنظر.',
